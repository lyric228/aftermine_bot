...
// Создание бота
//!!! НИЧЕГО КРОМЕ СТРОКИ НИЖЕ НЕ МЕНЯТЬ !!!
// логин Bot_TQ пароль 321456
createBot("Bot_TQ", "s5", "Bot_Tq", "321456");
// nickname - ник бота
// portal - портал куда заходит бот (пример: s1 - первое выживание, то есть йота, s5 - пятое выживание, то есть альфа и тд)
// warp - warp на котором должен быть бот всегда, если не указан, то бот будет в любой точке
// password - пароль от акка бота
